...
export HIGHLAND_PACKAGE_HIERARCHY=stoppingProtonAnalysis:pionAnalysis:pdStudies:pdBaseAnalysis:LArSoftReader:pdUtils:pdEventModel:$HIGHLAND_PACKAGE_HIERARCHY
