...
export HIGHLAND_PACKAGE_HIERARCHY=pionAnalysis:stoppingProtonAnalysis:pdStudies:pdSystematics:pdBaseAnalysis:LArSoftReader:pdUtils:pdEventModel:$HIGHLAND_PACKAGE_HIERARCHY
