...
export HIGHLAND_PACKAGE_HIERARCHY=pionAnalysis:stoppingProtonAnalysis:pdStudies:pdBaseAnalysis:LArSoftReader:pdUtils:pdEventModel:$HIGHLAND_PACKAGE_HIERARCHY
