...
//********************************************************************
  ...
  anaUtils::_categ->AddObjectCategory("ggdaughter", standardPDTree::seltrk_ndau, "seltrk_ndau", 
				      NPART, part_types, part_codes, part_colors,
				      3, -100, kaonAnalysisConstants::NMAXSAVEDGDAUGHTERS, kaonAnalysisConstants::NMAXSAVEDGGDAUGHTERS);
...
//********************************************************************
  ...
  for (Int_t idau = 0; idau<std::min((Int_t)kaonAnalysisConstants::NMAXSAVEDDAUGHTERS,(Int_t)part->Daughters.size()); idau++){
    ...
    for (Int_t jgdau = 0; jgdau < ngdau; jgdau++){
      ...
      // --------- ggdaughter category ------------------------
      Int_t nggdau = std::min((Int_t)kaonAnalysisConstants::NMAXSAVEDGGDAUGHTERS,(Int_t)gdau->Daughters.size());
	...
	kaonAnaUtils::FillGGDaughterKaonCategory(event, dau, gdau, ggdau, idau, jgdau, kggdau);
      ...
      for (Int_t kggdau = nggdau; kggdau < (Int_t)kaonAnalysisConstants::NMAXSAVEDGGDAUGHTERS; kggdau++){
    ...
    for (Int_t jgdau = ngdau; jgdau < (Int_t)kaonAnalysisConstants::NMAXSAVEDGDAUGHTERS; jgdau++){
      ...
      for (Int_t kggdau = 0; kggdau < (Int_t)kaonAnalysisConstants::NMAXSAVEDGGDAUGHTERS; kggdau++){
	kaonAnaUtils::FillGGDaughterCategory(event, dummy, idau, jgdau, kggdau);
	kaonAnaUtils::FillGGDaughterKaonCategory(event, dummy, dummy, dummy, idau, jgdau, kggdau);
      }
    }
