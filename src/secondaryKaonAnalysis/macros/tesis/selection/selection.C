...
void selection(){
  ...
  // draw.Draw(d,mc,"beam_mom",40,4,9,"beamparticlereduced","accum_level[0][0]>1 && beam_nominal_mom==6","","area pur ignoreempty");
  // tt1.DrawLatex(0.18,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis("fG"); gPad->Update();//always redraw axis
  // if(save_plots)gPad->Print("selection_BI_mom.pdf");
  
  // //candidates per event
  // draw.SetTitleX("Candidates per event");
  // draw.Draw(d,mc,"ncandidates",10,0,10,"beamparticlereduced","accum_level[0][]>1","","area pur ignoreempty");
  // tt1.DrawLatex(0.18,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_ncandidates.pdf");
  ...
  // gPad->RedrawAxis();gPad->Update(); //always redraw axis
  // gPad->Update();
  // if(save_plots)gPad->Print("selection_daughter_type.pdf");
  ...
  // draw.Draw(d,mc,"candidates_dau_chi2_muon/candidates_dau_chi2_ndf",20,0,20,"candidatedaumuonreduced","accum_level[0][]>3 && candidates_dau_chi2_muon>0 && (abs(candidates_endpos[][2]-230)>20 && abs(candidates_endpos[][2]-460)>20) && (abs(candidates_dau_pos[][2]-230)>20 && abs(candidates_dau_pos[][2]-460)>20)","","area pur ignoreempty nostat");
  // draw.DrawCutLineVertical(6,true,"l");
  // tt1.DrawLatex(0.18,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_daughter_chi2.pdf");
  ...
  tt1.DrawLatex(0.18,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  gPad->RedrawAxis();gPad->Update(); //always redraw axis
  if(save_plots)gPad->Print("selection_daughter_mom.pdf");
  ...
  // gPad->RedrawAxis();gPad->Update(); //always redraw axis
  // if(save_plots)gPad->Print("selection_candidate_cos.pdf");
  ...
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update(); //always redraw axis
  // if(save_plots)gPad->Print("selection_candidate_cos_endprocess.pdf");
  ...
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88); //legend shouldnt be over the axis
  // draw.Draw(d,mc,"candidates_distance_dau",50,0,100,"candidateparticlereduced","accum_level[0][]>6","","area pur ignoreempty");
  // draw.DrawCutLineVertical(10,true,"l");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->SetLogx();
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // gPad->Update();
  // if(save_plots)gPad->Print("selection_candidate_dis.pdf");
  
  // //candidate chi2 prot
  // draw.SetLogY(0);
  // draw.SetMinY(0);
  // gPad->SetLogx(0);
  // draw.SetTitleX("Candidate #chi^{2}_{prot}");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88); //legend shouldnt be over the axis
  // draw.Draw(mc,"candidates_chi2_prot/candidates_chi2_ndf",20,0,400,"candidateendprocess","candidates_chi2_prot/candidates_chi2_ndf>0 && accum_level[0][]>7 && candidates_truepdg==321","","area pur ignoreempty");
  // // draw.DrawCutLineVertical(90,true,"l");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_candidate_chi2.pdf");
  
  
  // //**************************************
  // //selection result
  // //**************************************
  // draw.SetTitleX("Candidate #chi^{2}_{proton}  [cm]");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88); //legend shouldnt be over the axis
  // draw.Draw(d,mc,"candidates_chi2_prot/candidates_chi2_ndf",20,0,400,"candidateparticlereduced","accum_level[0][]>7","","area pur ignoreempty");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_result_chi2.pdf");
  ...
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update(); //always redraw axis
  // if(save_plots)gPad->Print("selection_result_chi2_kaon.pdf");
  
  // draw.SetTitleX("Candidate Length [cm]");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88); //legend shouldnt be over the axis
  // draw.Draw(d,mc,"candidates_length",30,0,600,"candidateparticlereduced","accum_level[0][]>7","","area pur ignoreempty");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_result.pdf");
  
  // draw.SetTitleX("Candidate Z_{Start} [cm]");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88); //legend shouldnt be over the axis
  // draw.Draw(d,mc,"candidates_pos[][2]",30,0,600,"candidateparticlereduced","accum_level[0][]>7","","area pur ignoreempty");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_result_Zstart.pdf");
  
  // draw.SetTitleX("Candidate Z_{End} [cm]");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88); //legend shouldnt be over the axis
  // draw.Draw(d,mc,"candidates_endpos[][2]",30,0,600,"candidateparticlereduced","accum_level[0][]>7","","area pur ignoreempty");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update() //always redraw axis
  // if(save_plots)gPad->Print("selection_result_Zend.pdf");  
  ...
  // //other stuff plots
  // //**************************************
  // draw.SetTitleX("Candidate #chi^{2}_{proton}");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88);
  // draw.Draw(mc,"bestcandidate_chi2_prot/bestcandidate_chi2_ndf",9,-10000,10000,"bestcandidateparticle","accum_level[0][0]>6","","area pur ignoreempty");
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update()
  // if(save_plots)gPad->Print("endselection_candidate_chi2_endprocess.pdf");

  // draw.SetTitleX("Beam Particle End Z [cm]");
  // draw.SetLegendPos("r");
  // draw.SetLegendPos(0.57,0.88);
  // draw.Draw(d,mc,"seltrk_endpos[2]",70,0,700,"beamparticle","","","area pur ignoreempty");
  // tt1.DrawLatex(0.18,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update()
  // if(save_plots)gPad->Print("brokentracks_example.pdf");
  ...
  // tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  // gPad->RedrawAxis();gPad->Update();
  // if(save_plots)gPad->Print("endselection_candidate_mom.pdf");
  ...
  tt1.DrawLatex(0.10,0.94,"#bf{DUNE:ProtoDUNE-SP}");
  gPad->RedrawAxis();gPad->Update();
  if(save_plots)gPad->Print("endselection_candidate_mom_beampart.pdf");
