void broken_zi(){
  ...
  //std::string fmc   = dir+"systematics/weight_neweff.root";
  ...
  //draw.DrawRelativeErrors(syst,"bestcandidate_pos[2]",30,0,600,"accum_level>2 && bestcandidate_chi2_kaon>0","","SYS");
  ...
  gPad->Print("syst_brokentracks_zi_rel.pdf");
