void SystDiffError_BeamPIDSyst(){

  //open file
  std::string dir = "/dune/app/users/miagarc/technical_note/files/";
  std::string fmc   = dir+"systematics/systematics_beamPID.root";
  ...
  draw.DrawRelativeErrors(syst,"bestcandidate_chi2_kaon/bestcandidate_chi2_ndf",10,bins,"accum_level>6 && bestcandidate_chi2_kaon>0","","SYS");
  ...
  gPad->Print("plots/syst_rel_beamPIDeff.pdf");

  draw.SetTitleX("Candidate #chi^{2}_{K}");
  draw.DrawRelativeErrors(syst,"bestcandidate_chi2_kaon/bestcandidate_chi2_ndf",1,0,250,"accum_level>6 && bestcandidate_chi2_kaon>0","","SYS");
}
