void DrawSyst_chi2(){
  ...
  //std::string fmc   = dir+"systematics/syst_all_0.root";
  ...
  gStyle->SetStatW(0.2);
  gStyle->SetStatH(0.1);
  draw.SetStatPos(-999,1-0.075+0.05); //top of the pad - margin for plot + width of statsbox + width of the fram
  ...
  //syst->Project("h_mc_nominal","bestcandidate_chi2_kaon/bestcandidate_chi2_ndf","(accum_level>2 && bestcandidate_chi2_kaon>0)*weight_syst_total*toy_weight");
  syst->Project("h_mc_nominal","bestcandidate_chi2_kaon_perndf_toy","(accum_level>2 && bestcandidate_chi2_kaon>0)*weight_syst_total*toy_weight");
  ...
  //draw.DrawRelativeErrors(syst,"bestcandidate_chi2_kaon/bestcandidate_chi2_ndf",nbins,edges,"accum_level>2 && bestcandidate_chi2_kaon>0","","SYS");
  draw.DrawRelativeErrors(syst,"bestcandidate_chi2_kaon_perndf_toy",nbins,edges,"accum_level>2 && bestcandidate_chi2_kaon>0","","SYS");
  ...
  d->Project("h_data","bestcandidate_chi2_kaon/bestcandidate_chi2_ndf","accum_level[0][]>6 && bestcandidate_chi2_kaon>0");
  ...
  h_mc_syst->GetXaxis()->SetTitle("Candidate #chi^{2}_{K}");
  ...
  // TPaveStats* st = (TPaveStats*)h_mc_syst->GetFunction("stats");
  // st->Dump();

  //draw legend now
  TLegend* lg = new TLegend(0.52,0.47,0.85,0.8);
  ...
  gPad->Print("SYST_final_kaon_chi2.pdf");

  // draw.DrawRelativeErrors(syst,"bestcandidate_chi2_kaon_perndf_toy",1,0,250,"accum_level>2 && bestcandidate_chi2_kaon>0","","SYS");
}
