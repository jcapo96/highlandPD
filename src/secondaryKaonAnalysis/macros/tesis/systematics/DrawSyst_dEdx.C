void DrawSyst_dEdx(){
  ...
  syst->Project("h_mc_nominal","bestcandidate_hit_dedx_toy[][]","(accum_level>2 && bestcandidate_chi2_kaon_perndf_toy<50)*weight_syst_total*toy_weight");
  ...
  draw.DrawRelativeErrors(syst,"bestcandidate_hit_dedx_toy",nbins,0,10,"accum_level>2 && bestcandidate_chi2_kaon_perndf_toy<50","","SYS");
  ...
  d->Project("h_data","bestcandidate_hit_dedx","accum_level[0]>2 && bestcandidate_chi2_kaon/bestcandidate_chi2_ndf<50");
  h_data->Draw();
