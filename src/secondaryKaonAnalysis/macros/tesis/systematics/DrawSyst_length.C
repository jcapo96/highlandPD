void DrawSyst_length(){
  ...
  //***************************************
  //draw first the full sample
  //***************************************

  //get MC nominal
  TH1F* h_mc_nominal = new TH1F("h_mc_nominal","h_mc_nominal",nbins,edges);
  syst->Project("h_mc_nominal","bestcandidate_length_toy","(accum_level>2)*weight_syst_total*toy_weight");
  ...
  draw.DrawRelativeErrors(syst,"bestcandidate_length_toy",nbins,edges,"accum_level>2","","SYS");
  ...
  d->Project("h_data","bestcandidate_length","accum_level[0][]>6");
  ...
  gPad->Print("SYST_final_length.pdf");
}
