void DrawSyst_Zi(){
  ...
  syst->Project("h_mc_nominal","bestcandidate_Zstart_toy","(accum_level>2)*weight_syst_total*toy_weight");
  ...
  draw.DrawRelativeErrors(syst,"bestcandidate_Zstart_toy",nbins,edges,"accum_level>2","","SYS");
  ...
  h_mc_syst->GetXaxis()->SetTitle("Candidate Z Start [cm]");
