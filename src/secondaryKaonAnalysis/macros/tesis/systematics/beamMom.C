void beamMom(){
  ...
  //std::string fmc   = dir+"systematics/6-7GeV_prod4a_microtree_syst_beamMom_2023-04-06.root";
  std::string fmc   = dir+"systematics/syst_momNorm.root";
  ...
  draw.DrawRelativeErrors(syst,"bestcandidate_chi2_kaon/bestcandidate_chi2_ndf",1000,0,250,"accum_level>2 && bestcandidate_chi2_kaon>0","","SYS");
  ...
  gPad->Print("syst_beamMom_rel.pdf");
