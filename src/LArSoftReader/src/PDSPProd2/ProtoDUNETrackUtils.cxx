...
std::vector<anab::CosmicTag> protoana::ProtoDUNETrackUtils::GetRecoTrackCosmicTag(const recob::Track &track,  std::string trackModule) const{
...
std::vector<anab::T0> protoana::ProtoDUNETrackUtils::GetRecoTrackT0(const recob::Track &track,  std::string trackModule) const{
...
std::vector<anab::Calorimetry> protoana::ProtoDUNETrackUtils::GetRecoTrackCalorimetry(const recob::Track &track,  const std::string trackModule, const std::string caloModule) const{
...
const std::vector<const recob::Hit*> protoana::ProtoDUNETrackUtils::GetRecoTrackHits(const recob::Track &track,  const std::string trackModule) const{
...
const std::vector<const recob::Hit*> protoana::ProtoDUNETrackUtils::GetRecoTrackHitsFromPlane(const recob::Track &track,  const std::string trackModule, unsigned int planeID ) const{
...
std::vector< float >  protoana::ProtoDUNETrackUtils::CalibrateCalorimetry(  const recob::Track &track,  const std::string trackModule, const std::string caloModule, const fhicl::ParameterSet &ps ) {
...
// Get the hits from a given reco track
unsigned int protoana::ProtoDUNETrackUtils::GetNumberRecoTrackHits(const recob::Track &track,  const std::string trackModule) const{
...
std::vector<anab::ParticleID> protoana::ProtoDUNETrackUtils::GetRecoTrackPID(const recob::Track &track,  const std::string trackModule, const std::string pidModule) const{
...
protoana::BrokenTrack protoana::ProtoDUNETrackUtils::IsBrokenTrack( const recob::Track &track,  const std::string trackModule, const std::string caloModule, const fhicl::ParameterSet & BrokenTrackPars, const fhicl::ParameterSet & CalorimetryPars ){
...
std::pair< double, int > protoana::ProtoDUNETrackUtils::Chi2PIDFromTrack_MC( const recob::Track &track,  const std::string trackModule, const std::string caloModule, TProfile * profile ){
...
std::map< size_t, const recob::Hit * > protoana::ProtoDUNETrackUtils::GetRecoHitsFromTrajPoints(const recob::Track & track, std::string trackModule){
...
bool protoana::ProtoDUNETrackUtils::IsBeamlike( const recob::Track & track, const fhicl::ParameterSet & BeamPars, bool flip ){
