...
#ifndef art__Wrapper_vector_simb__MCParticle____h
#define art__Wrapper_vector_simb__MCParticle____h
#include <vector>
...
template <> class Wrapper<vector<simb::MCParticle> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<simb::MCParticle> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<simb::MCParticle> obj;           // (simb::MCParticle)
