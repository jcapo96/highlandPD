...
#ifndef art__Assns_recob__Track_anab__Calorimetry_void__h
#define art__Assns_recob__Track_anab__Calorimetry_void__h
namespace recob {
class Track;
} // end of namespace.
namespace anab {
...
namespace art {
template <typename T0, typename T1, typename T2> class Assns;
template <> class Assns<recob::Track,anab::Calorimetry,void> : public art::detail::AssnsBase {
