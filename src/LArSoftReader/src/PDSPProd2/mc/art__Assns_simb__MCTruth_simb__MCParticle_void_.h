...
#ifndef art__Assns_simb__MCTruth_simb__MCParticle_void__h
#define art__Assns_simb__MCTruth_simb__MCParticle_void__h
namespace simb {
class MCTruth;
} // end of namespace.
namespace simb {
...
template <> class Assns<simb::MCTruth,simb::MCParticle,void>;
} // end of namespace.
...
namespace art {
template <typename T0, typename T1, typename T2> class Assns;
template <> class Assns<simb::MCTruth,simb::MCParticle,void> : public art::detail::AssnsBase {
