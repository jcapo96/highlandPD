...
#ifndef art__Assns_recob__SpacePoint_recob__Hit_void__h
#define art__Assns_recob__SpacePoint_recob__Hit_void__h
namespace recob {
class SpacePoint;
} // end of namespace.
namespace recob {
...
namespace art {
template <typename T0, typename T1, typename T2> class Assns;
template <> class Assns<recob::SpacePoint,recob::Hit,void> : public art::detail::AssnsBase {
