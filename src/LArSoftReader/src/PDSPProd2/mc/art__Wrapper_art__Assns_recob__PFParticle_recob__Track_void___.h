...
#ifndef art__Wrapper_art__Assns_recob__PFParticle_recob__Track_void____h
#define art__Wrapper_art__Assns_recob__PFParticle_recob__Track_void____h
namespace recob {
class PFParticle;
} // end of namespace.
namespace recob {
...
template <> class Wrapper<art::Assns<recob::PFParticle,recob::Track,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::PFParticle,recob::Track,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::PFParticle,recob::Track,void> obj;           //
