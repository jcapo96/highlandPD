...
#ifndef art__Wrapper_vector_art__RNGsnapshot____h
#define art__Wrapper_vector_art__RNGsnapshot____h
#include <vector>
...
template <> class Wrapper<vector<art::RNGsnapshot> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<art::RNGsnapshot> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<art::RNGsnapshot> obj;           // (art::RNGsnapshot)
