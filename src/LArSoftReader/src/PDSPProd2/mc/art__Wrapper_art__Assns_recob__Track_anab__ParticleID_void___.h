...
#ifndef art__Wrapper_art__Assns_recob__Track_anab__ParticleID_void____h
#define art__Wrapper_art__Assns_recob__Track_anab__ParticleID_void____h
namespace recob {
class Track;
} // end of namespace.
namespace anab {
...
template <> class Wrapper<art::Assns<recob::Track,anab::ParticleID,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Track,anab::ParticleID,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Track,anab::ParticleID,void> obj;           //
