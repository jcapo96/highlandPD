...
#ifndef art__Wrapper_art__Assns_recob__Wire_recob__Hit_void____h
#define art__Wrapper_art__Assns_recob__Wire_recob__Hit_void____h
namespace recob {
class Wire;
} // end of namespace.
namespace recob {
...
template <> class Wrapper<art::Assns<recob::Wire,recob::Hit,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Wire,recob::Hit,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Wire,recob::Hit,void> obj;           //
