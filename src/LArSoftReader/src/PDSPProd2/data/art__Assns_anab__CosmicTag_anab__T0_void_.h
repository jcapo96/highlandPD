...
#ifndef art__Assns_anab__CosmicTag_anab__T0_void__h
#define art__Assns_anab__CosmicTag_anab__T0_void__h
namespace anab {
class CosmicTag;
} // end of namespace.
namespace anab {
...
namespace art {
template <typename T0, typename T1, typename T2> class Assns;
template <> class Assns<anab::CosmicTag,anab::T0,void> : public art::detail::AssnsBase {
