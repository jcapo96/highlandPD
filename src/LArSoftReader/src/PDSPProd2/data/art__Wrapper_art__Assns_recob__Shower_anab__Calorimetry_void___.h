...
#ifndef art__Wrapper_art__Assns_recob__Shower_anab__Calorimetry_void____h
#define art__Wrapper_art__Assns_recob__Shower_anab__Calorimetry_void____h
namespace recob {
class Shower;
} // end of namespace.
namespace anab {
...
template <> class Assns<recob::Shower,anab::Calorimetry,void>;
} // end of namespace.
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Shower,anab::Calorimetry,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Shower,anab::Calorimetry,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Shower,anab::Calorimetry,void> obj;           //
