...
#ifndef art__Assns_recob__PFParticle_recob__Shower_void__h
#define art__Assns_recob__PFParticle_recob__Shower_void__h
namespace recob {
class PFParticle;
} // end of namespace.
namespace recob {
...
namespace art {
template <typename T0, typename T1, typename T2> class Assns;
template <> class Assns<recob::PFParticle,recob::Shower,void> : public art::detail::AssnsBase {
