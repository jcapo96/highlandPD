...
#ifndef art__Wrapper_art__Assns_recob__Cluster_recob__EndPoint2D_unsigned_short____h
#define art__Wrapper_art__Assns_recob__Cluster_recob__EndPoint2D_unsigned_short____h
namespace recob {
class Cluster;
} // end of namespace.
namespace recob {
...
template <> class Wrapper<art::Assns<recob::Cluster,recob::EndPoint2D,unsigned short> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Cluster,recob::EndPoint2D,unsigned short> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Cluster,recob::EndPoint2D,unsigned short> obj;           //
