...
#ifndef art__Wrapper_art__Assns_recob__Track_recob__Hit_void____h
#define art__Wrapper_art__Assns_recob__Track_recob__Hit_void____h
namespace recob {
class Track;
} // end of namespace.
namespace recob {
...
template <> class Assns<recob::Track,recob::Hit,void>;
} // end of namespace.
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Track,recob::Hit,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Track,recob::Hit,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Track,recob::Hit,void> obj;           //
