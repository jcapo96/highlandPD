...
#ifndef art__Wrapper_art__Assns_recob__Track_recob__SpacePoint_void____h
#define art__Wrapper_art__Assns_recob__Track_recob__SpacePoint_void____h
namespace recob {
class Track;
} // end of namespace.
namespace recob {
...
template <> class Wrapper<art::Assns<recob::Track,recob::SpacePoint,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Track,recob::SpacePoint,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Track,recob::SpacePoint,void> obj;           //
