...
#ifndef art__Wrapper_vector_sim__AuxDetSimChannel____h
#define art__Wrapper_vector_sim__AuxDetSimChannel____h
#include <vector>
...
template <> class Wrapper<vector<sim::AuxDetSimChannel> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<sim::AuxDetSimChannel> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<sim::AuxDetSimChannel> obj;           // (sim::AuxDetSimChannel)
