...
#ifndef art__Assns_recob__Vertex_recob__Track_void__h
#define art__Assns_recob__Vertex_recob__Track_void__h
namespace recob {
class Vertex;
} // end of namespace.
namespace recob {
...
namespace art {
template <typename T0, typename T1, typename T2> class Assns;
template <> class Assns<recob::Vertex,recob::Track,void> : public art::detail::AssnsBase {
