...
#ifndef art__Wrapper_art__Assns_recob__PFParticle_larpandoraobj__PFParticleMetadata_void____h
#define art__Wrapper_art__Assns_recob__PFParticle_larpandoraobj__PFParticleMetadata_void____h
namespace recob {
class PFParticle;
} // end of namespace.
...
template <> class Assns<recob::PFParticle,larpandoraobj::PFParticleMetadata,void>;
} // end of namespace.
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::PFParticle,larpandoraobj::PFParticleMetadata,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::PFParticle,larpandoraobj::PFParticleMetadata,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::PFParticle,larpandoraobj::PFParticleMetadata,void> obj;           //
