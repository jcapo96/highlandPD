...
#ifndef art__Wrapper_vector_recob__OpFlash____h
#define art__Wrapper_vector_recob__OpFlash____h
#include <vector>
...
template <> class Wrapper<vector<recob::OpFlash> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<recob::OpFlash> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<recob::OpFlash> obj;           // (recob::OpFlash)
