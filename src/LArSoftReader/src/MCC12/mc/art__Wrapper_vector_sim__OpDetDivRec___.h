...
#ifndef art__Wrapper_vector_sim__OpDetDivRec____h
#define art__Wrapper_vector_sim__OpDetDivRec____h
#include <vector>
...
template <> class Wrapper<vector<sim::OpDetDivRec> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<sim::OpDetDivRec> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<sim::OpDetDivRec> obj;           // (sim::OpDetDivRec)
