...
#ifndef art__Wrapper_vector_CRT__Trigger____h
#define art__Wrapper_vector_CRT__Trigger____h
#include <vector>
...
template <> class Wrapper<vector<CRT::Trigger> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<CRT::Trigger> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<CRT::Trigger> obj;           // (CRT::Trigger)
