...
#ifndef art__Wrapper_art__Assns_recob__Slice_recob__Hit_void____h
#define art__Wrapper_art__Assns_recob__Slice_recob__Hit_void____h
namespace recob {
class Slice;
} // end of namespace.
namespace recob {
...
template <> class Wrapper<art::Assns<recob::Slice,recob::Hit,void> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<art::Assns<recob::Slice,recob::Hit,void> > : public art::EDProduct {
...
// Data Members.
   ...
   art::Assns<recob::Slice,recob::Hit,void> obj;           //
