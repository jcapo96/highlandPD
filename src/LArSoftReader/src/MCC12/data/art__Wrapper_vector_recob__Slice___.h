...
#ifndef art__Wrapper_vector_recob__Slice____h
#define art__Wrapper_vector_recob__Slice____h
#include <vector>
...
template <> class Wrapper<vector<recob::Slice> >;
} // end of namespace.
...
namespace art {
template <typename T0> class Wrapper;
template <> class Wrapper<vector<recob::Slice> > : public art::EDProduct {
...
// Data Members.
   ...
   vector<recob::Slice> obj;           // (recob::Slice)
