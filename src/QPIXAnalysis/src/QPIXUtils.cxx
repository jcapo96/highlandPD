...
//********************************************************************
  ...
  std::string types[] = {"B8", "hep", "Ar39"    , "Ar42"    , "Bi214"   ,  "K42"     , "Kr85"    , "Pb214"   , "Po214"   , "Po218"   , "Rn222"   , "#gamma", NAMEOTHER};
  int codes[]         = {8   , 9    , 1000180390, 1000180420, 1000832140,  1000190420, 1000360850, 1000822140, 1000842140, 1000842180, 1000862220, 22      , CATOTHER};
  int colors[]        = {2   , 208  , 3         , 4         , 94        ,  31        ,  92       , 8         , 1         , 33        , 9         , 70      , COLOTHER};
