#ifndef pdExampleSelection_h
#define pdExampleSelection_h
...
class pdExampleSelection: public SelectionBase{
 public:
  pdExampleSelection(bool forceBreak=true);
  virtual ~pdExampleSelection(){}
