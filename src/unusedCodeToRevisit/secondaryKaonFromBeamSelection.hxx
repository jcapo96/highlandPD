#ifndef secondaryKaonFromBeamSelection_h
#define secondaryKaonFromBeamSelection_h
...
class secondaryKaonFromBeamSelection: public SelectionBase{
 public:
  secondaryKaonFromBeamSelection(bool forceBreak=true);
  virtual ~secondaryKaonFromBeamSelection(){}
...
class GetKaonsFromBeamAction: public StepBase{
 public:
  using StepBase::Apply;
  bool Apply(AnaEventC& event, ToyBoxB& box) const;
  StepBase* MakeClone(){return new GetKaonsFromBeamAction();}
};
